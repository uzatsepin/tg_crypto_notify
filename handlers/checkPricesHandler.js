...
checkPricesHandler.callbackQuery("cur_price", async (ctx) => {
	...
	await ctx.reply("По какой валюте необходимо узнать цену? 👇", {
...
addCoinHandler.callbackQuery(/price_/, async (ctx) => {
	...
	await ctx.reply("Получаем данные о монете...");
